...
(defn reaction [image-source image-alt audio-source]
  (html
    [:img {:src image-source :alt image-alt}]
    [:embed {:src audio-source :autostart "true" :hidden "true" :loop "false"}]))

(defn yes []
  (reaction "http://dl.dropbox.com/u/16607608/Skim_yes.png" "Yessss" "http://dl.dropbox.com/u/16607608/SkimYes.mp3"))

(defn sigh []
  (reaction "http://dl.dropbox.com/u/16607608/Skim_sigh.png" "Ugh..." "http://dl.dropbox.com/u/16607608/Skim_sigh.mp3"))
